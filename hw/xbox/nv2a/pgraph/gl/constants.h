...
#ifdef XEMU_BROWSER_GL_EXPERIMENT
        {2, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, GL_COLOR_ATTACHMENT0},
#else
...
#ifdef XEMU_BROWSER_GL_EXPERIMENT
        {4, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, GL_COLOR_ATTACHMENT0},
#else
...
#ifdef XEMU_BROWSER_GL_EXPERIMENT
        {1, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, GL_COLOR_ATTACHMENT0},
#else
